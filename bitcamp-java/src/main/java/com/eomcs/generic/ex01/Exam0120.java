// 제네릭(Generic) - java.util.ArrayList // 제네릭이 적용된 클래스를 사용해보자
...
public class Exam0120 {
  public static void main(String[] args) {
    ...
    //    클래스명<타입명>
    //
    ArrayList<Member> list = new ArrayList<Member>(); //우측 Member 생략가능
    ...
    // => 형변환하는 번거로움이 없다.
    Member member = list.get(0); //마우스 대면 "Member java.util.ArrayList.get(int index)" 뜸!! 멤버랭 리턴타입이
