...
public class Exam0113 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // UTF-8 문자코드의 바이트 배열을 사용하여 String 인스턴스 초기화 시키기.
        byte[] bytes = {
            (byte)0x41, // A
            (byte)0x42, // B
            (byte)0x43, // C
        ...
        // 따라서 위 예제를 Linux, macOS, Unix 의 CLI(Command Line Interface)에서 실행하면
        // 정상적으로 한글 문자열이 출력되지만, 
        ...
        //
        // 이유?
        // => Linux, macOS, Unix가 기본으로 사용하는 문자코드표는 UTF-8이다.
        // => Windows가 기본으로 사용하는 문자코드표는 MS949이다.
        //
        // 그런데 이클립스에서 실행하면 깨지지 않는 이유?
        // => 이클립스에서 JVM을 실행할 때 입출력 기본 인코딩을 UTF-8로 설정하기때문이다.
        //
...
// 외부 입출력에 대해서 기본 캐릭터셋 뭐 써야할 지 잘 설정해야함.
// 자바는 UCS2를 씀 / 윈도우는 MS949 / 리눅스유닉스맥오에스UTF-8
// 기본이 UTF8로 작업하고, 실행 시 OS상관없이 -Dfile.encoding-UTF-8 무조건 주고 실행해.
