...
public class Member implements java.io.Serializable {
  // 이 클래스는 시리얼라이저블할수있어요라고 JVM에게알려주는 용도의 구현 implements
  // 노란색 줄 The serializable class Member does not declare a static final serialVersionUID field of type long
  String name;
  int age;
