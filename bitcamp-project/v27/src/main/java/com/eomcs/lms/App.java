 ...
 * 
 * 
 * 예외가 자바 버추얼 머신 끝까지 보고되는 순간 멈춤 중간에 캐치 가로채는것.
 * 
 * 그러나 예외 중에 가로채지 말아야 할 것이 있음 대표적으로 아웃오브 메모리. 이것은 자바 버추얼머신이 알아야함. 다만 보고하기 전에 임시로 저장하고 보고해야함.
 * 
 * 프로그램 오류 2개: 자바버추얼머신에게 전달할수밖에 없는 오류 = 에러 프로그램에서 처리할 수 있는 문제 = 예외 익셉션
 * 
 * 
 * 
 */
