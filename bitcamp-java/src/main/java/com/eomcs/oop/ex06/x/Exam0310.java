...
public class Exam0310 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(s1.equals(s2)); // 왜 true가 나와?!
    ...
    // String 클래스 처럼 toString()을 오버라이딩 하라!
    // Exam0320.java를 보라!
  }
}


// 원래 이퀄스는 인스턴스가 다르면(값이 같은지 따지지 않음) false를 리턴한다. (연산자 ==와 같음)
// 스트링 클래스가 특이한거야. 인스턴스가 같은지가 아니라 내용이 같은지 오버라이딩 했기 때문에 가능한 것.
// 이퀄스는 오브젝트에서 상속받은 애고 오버라이딩하지 않으면 기본동작함 - 인스턴스 같을때만 트루
// 
