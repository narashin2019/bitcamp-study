...
public class Exam01 implements B {
  ...
  public void m1() {} // B의 수퍼인터페이스의 메서드까지 구현해야 한다. (인터페이스도 상속받음)
  ...
  public static void main(String[] args) {
    ...
    // 클래스 타입 레퍼런스는 해당 클래스에 정의된 메서드를 호출할 수 있다.(프라이빗은 호출 x)
    obj.m1();
    obj.m2();
    obj.x1();
    obj.x2();
    ...
    B obj2 = obj;
    obj2.m2(); //B의 m2() => B.m2()라고도 표현함. 스태틱메서드라는 말 아님. 
    obj2.m1(); //A의 m1() <== B가 상속받은 인터페이스의 메서드
    //obj2.x1(); 컴파일 오류
    //obj2.x2(); 컴파일 오류
