...
public class App {
  ...
  public static void main(String[] args) {
    ...
    Prompt ptompt = new Prompt(keyboard);
    
    BoardHandler boardHandler = new BoardHandler(ptompt); 
    LessonHandler lessonHandler = new LessonHandler(ptompt);
    MemberHandler memberHandler = new MemberHandler(ptompt); 
