...
public class Exam0230 {
  public static void main(String[] args) {
    ...
    // => 그래서 같은 값이 더라도 다른 인스턴스가 생성된다. (주소가다름)
    
    Integer obj3 = 100; // Integer.valueOf(100)과 같다
    Integer obj4 = 100; // Integer.valueOf(100)과 같다
    System.out.println(obj3 == obj4);
    // 설명:
    // => 정수 리터럴을 이용하여 auto-boxing으로 객체를 생성할 경우 constants pool에 생성된다.
    // => 같은 값을 가지는 정수 Integer 객체가 여러 개 존재해야 할 필요가 없다.
