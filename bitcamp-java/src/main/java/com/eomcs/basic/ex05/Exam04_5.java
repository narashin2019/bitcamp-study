...
public class Exam04_5 {
    public static void main(String[] args) {
        ...
        // 32비트에서 뒤에 8비트를 사용하여 8개의 true.false값을 저장할 수 있다.
        ...
        lang2 |= 0x80; // c = true // lang2 = lang2 | 0x80 // sum += i => sum = sum + i
        // 00000000 | 10000000 = 10000000

        //lang2 |= 0x00; // c++ = false // 굳이 할 필요 없음
        ...
        // 실무에서는 이렇게  비트를 이용하여 여러 개의 데이터의 true/false 상태를 저장하기도 한다.
