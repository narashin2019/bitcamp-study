...
public class Exam0120 {
  ...
  // 메서드 선언부에 발생되는 예외를 명시하는 것이 좋다. (안해도 되지만 하는게 좋다)
  //
  // => 그런데 조금 아쉬움이 있는 점은
  // read() 메서드를 사용하는 개발자가
  ...
  public static void main(String[] args) {
    try {
      ...
      // e.printStackTrace(); // 에러가 뜬 이유를 호출 순서 역으로 보여줌. 스택!! 마지막부터 역순으로 내려가
    }

  }
}

// RuntimeException : 실행중에 발생된 예외인데 무슨 실행중에? 말하기 어려움. 0130예제를 보셈
