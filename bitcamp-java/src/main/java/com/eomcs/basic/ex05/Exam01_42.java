...
public class Exam01_42 {
  public static void main(String[] args) {
    ...
    // 다른 타입이 될 수 없다.
    // => 인트의 양수 최대값 0111 1111 1111 1111 1111 1111 1111 1111 = Integer.MAX_VALUE
    //
    int x = Integer.MAX_VALUE; // 0x7fffffff = 약 +21억
    int y = Integer.MAX_VALUE; // 0x7fffffff = 약 +21억
    int r1 = x + y; // 0x7fffffff + 0x7fffffff = 0xfffffffe = -2가 나옴!!!
    //  0111 1111 1111 1111 1111 1111 1111 1111 (x)
    //+ 0111 1111 1111 1111 1111 1111 1111 1111 (y)
    //--------------------------------------------
    //  1111 1111 1111 1111 1111 1111 1111 1110 // 4바이트에서 맨앞 숫자가 1이면 음수.
    ...
    // 진정한 해결책?
    // - int와 int 연산 결과가 int 크기(21억)를 넘어갈 것 같으면 연산 전에 형변환해서 계산하라!
    r2 = (long)x + (long)y;
    System.out.println(r2); //4294967294 출력
