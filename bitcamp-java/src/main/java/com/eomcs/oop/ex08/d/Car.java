...
public abstract class Car {
    ...
    // 
    public abstract void run(); //중괄호 없이 끝. public abstract순서는 자기맴.
    
    //상속받는 입장에서는 서브클래스에 맞게끔 오버라이드하셔라.
    // 서브클래스에게 이 메서드 오버라이드해서 쓰라고 강제하고 싶을떄.
    // 일반 클래스는 추상메서드를 가질수 없다. 추상클래스여야 한다.
