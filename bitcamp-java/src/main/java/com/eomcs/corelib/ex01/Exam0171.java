...
public class Exam0171 {
  ...
  static class Score {
    ...
    @Override
    public Score clone() throws CloneNotSupportedException { //   public만 바꿈. Score로 바꿈
  ...
  public static void main(String[] args) throws Exception {
    ...
    Score s2 = s1.clone(); // 실행 오류! (run-time error) //컴파일러야 예외 발생한것 메인메서드 호출한 쪽에 던져놔 너가 트라이 캐치로 예외 처리할 필요 없다
    ...
    //    Score 클래스에 복제 기능을 활성화 시키는 설정을 해야 한다.
    //
