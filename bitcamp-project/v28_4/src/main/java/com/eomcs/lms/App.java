...
public class App {
  ...
  private static void loadLessonData() {
    ...
    try (BufferedReader in = new BufferedReader(new FileReader(file))) { // 맨끝문장은 세미콜론을 붙여도 생략해도 된다.
  ...
  private static void saveLessonData() {
    ...
    try (BufferedWriter out = new BufferedWriter(new FileWriter(file))) { // 하나만 클로스 해도 둘다 닫힌다.
  ...
  private static void loadMemberData() {
    ...
    try (BufferedReader in = new BufferedReader(new FileReader(file))) {
      ...
      memberList.addAll(Arrays.asList(new Gson().fromJson(in, Member[].class))); // 리스트구현체는 컬렉션구현체다.
  ...
  private static void loadBoardData() {
    ...
    try (BufferedReader in = new BufferedReader(new FileReader(file))) { // 파일리더에 버퍼드리더 붙임
