...
public class Exam04_6 {
  public static void main(String[] args) {
    ...
    if ((lang & 0x80) == 0x80) System.out.print("c "); //if ((lang & 0x80) > 0) System.out.print("c ");
    //   11100011
    // & 10000000 (&10000000은 1은 필터 0은 가림막)
    // ---------
    //   10000000

    if ((lang & 0x40) > 0) System.out.print("cpp ");
    //   11100011
    // & 01000000 (&10000000은 1은 필터 0은 가림막)
    // ---------
    //   01000000

    if ((lang & 0x20) > 0) System.out.print("java ");
    //   11100011
    // & 00100000 (&10000000은 1은 필터 0은 가림막)
    // ---------
    //   00100000

    if ((lang & 0x10) > 0) System.out.print("js ");
    //   11100011
    // & 00010000 (&10000000은 1은 필터 0은 가림막)
    // ---------
    //   00000000
