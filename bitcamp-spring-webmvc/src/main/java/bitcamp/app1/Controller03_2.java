...
public class Controller03_2 {
  ...
  // 테스트 방법:
  // => http://localhost:9999/bitcamp-spring-webmvc/html/app1/c03_2.html
  ...
  // @RequestMapping(method = RequestMethod.GET, headers = "name") //위와 같은 코드!
  @ResponseBody
  ...
  // => http://localhost:9999/bitcamp-spring-webmvc/app1/c03_2 테스트
  @GetMapping
  @ResponseBody
