...
public class BoardListCommand implements Command {
  ...
  public BoardListCommand(ObjectOutputStream out, ObjectInputStream in) { // 마이크와 스피커 생성자에 받아놓고 있다가
    this.out = out;
    this.in = in;
  }
