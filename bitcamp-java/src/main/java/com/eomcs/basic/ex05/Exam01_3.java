...
public class Exam01_3 {
    public static void main(String[] args) {
        ...
        // byte(1바이트) 변수에 저장할 수 있다면(-128~127이내) 허락한다!
      
        b = 5 + 6;
        // 리터럴끼리 산술 연산한 결과도 리터럴로 간주한다.
        // 그 결과 값이 변수의 범위 내의 값이면 허락한다.
        // 컴파일러가 해당 문장 실행 시 5+6은 값을 알기 때문에 b=11로 할 수 있음.
        ...
        z = x; //ok
        z = y; //ok
        // 컴파일러는 기계어로 번역만 함. 한줄한줄번역을 하지 기억을하지 않음.
        // JVM이 실행을 하는 것.
        // 컴파일러는 z = x;에서 x=5들어 가는 것을 몰라 실행 전까지.
        
        z = x + y; 
        // 컴파일 오류! Type mismatch: cannot convert from int to byte
