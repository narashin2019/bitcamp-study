...
public class Exam0130 {
  ...
  public static void test1() {
    // JavaFilter는 non-static cested class이기 때문에
    // 인스턴스를 호출할 때 반드시 바깥 클래스의 인스턴스가 필요하다.
    // 따라서 이 메서드 처럼 static 메서드에서 해당 클래스를 사용하려 한다면
    // 오류가 발생할 것이다.
    // 
  ...
  public void test2() {
    ...
    // 인스턴스 메서드 에서는 non-static nested class의 인스턴스를 생성할 수 있다. 
