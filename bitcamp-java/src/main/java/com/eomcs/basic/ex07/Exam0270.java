...
public class Exam0270 {
  ...
  //    예) m1("aaa", "bbb", "aaa@test.com", "bbb@teat.com");
  ...
  // => 아규먼트의 시작과 끝을 구분할 수 없다.
  //    예) m2("aaaa");
  //static void m2(String... names, String a) {} // 컴파일 오류! The variable argument type String of the method m2 must be the last parameter
...
// trade off=거래, 속도냐 소스코드의 유지보수하기 좋은가
