...
public class Exam0320 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 해당되는 클래스의 객체를 만들어서 리턴/ 나는 레퍼런스변수 선언과 형변환만 정확히 해주면 됨
    ...
    // local class incompatible: stream classdesc serialVersionUID = -6756422078349366906, local
    // class serialVersionUID = 5966893847301092247
    //
...
// FileInputStream 데이터 싱크 시스템
// BufferedInputStream, ObjectInputStream 데이터프로세싱시스템(데코레이터)

// 오브젝트스트림이 크기는 좀 커지나 편리하다.
